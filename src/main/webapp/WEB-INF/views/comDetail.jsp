...
<html>
	<head>
		...
		<style>
	        ...
	        .container,.eval{text-align:center;}
	        .row,.row_title{width:650px;height:50px;line-height:50px;font-size:20px;}
	        .row,.row_header,.row_title{background:#E4EEF0;font-family:fallB;}
	        .container{margin-top:150px;}
	        .eval{width:650px;}
	        .row_title{border:1px solid #000;text-align:left;padding-left:30px;float:left;display:inline-block;}
	        .row{float:left;display:inline-block;text-align:center;}
	        .row_body,.row_header{height:50px;line-height:50px;text-align:center;display:inline-block;border:1px solid #000;float:left;font-size:14px;}
	        .row_header{width:150px;}
	        .row_body{width:500px;background:#fff;font-family:fallM;}
	        .star_grade{height:15px;margin-top:15px;}
   		</style>
  	</head>
	<body>
