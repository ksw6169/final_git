<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
        ...
        <body>
            ...
            <form action="./evalUpdate" method="post">
                <div class="col-md-6 col-md-offset-3 comWrite">
                    <div class="input_comWrite">
                        <h1 class="content">기업평가</h1>
                        <input type="hidden" name="evaluation_no" value="${evaluationDTO.evaluation_no}"/>
                        <input type="hidden" name="company_no" value="${evaluationDTO.company_no}"/>
	            ...
	            <textarea id="comment" class="col-md-6 col-md-offset-3" name="evaluation_comment" rows="8"></textarea>
	            <br />
	            ...
	            <div class="col-md-6 col-md-offset-3 button_group">
	                <button class="comWrite_btn">기업 수정 완료</button>
	            </div>
	            </form>
        </body>
        ...
        <script>
        	...
        	$("#row4p"+"${evaluationDTO.evaluation_vacation}").attr('checked', true);
        	$("#comment").text("${evaluationDTO.evaluation_comment}");
