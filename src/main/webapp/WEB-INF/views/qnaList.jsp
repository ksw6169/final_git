...
<html>
	<head>
		...
		<style>
         ...
         .caption_detail,.thumbnail_contents{text-align:center;white-space:pre-line;}
         .thumbnail_header{text-align:center;vertical-align:middle;width:100%;height:250px;font-size:15px;font-family:bareun;border:.25px solid #DDD;background-color:#121F27;color:#fff;}
         .caption_detail{margin:0 auto;float:left;width:33.3%;height:50px;font-family:fallM;font-size:12px;background-color:#E4EEF0;padding-top:7px;border:.25px solid #DDD;}
         .thumbnail{height:335px;}
         .thumbnail_contents{width:100%;height:200px;margin-top:105px;}
         .search_btn,select{height:50px;float:left;}
         .search_div{margin-top:50px;margin-bottom:150px;width:430px;}
         ...
         .align_btn,select{display:inline-block;}
         .search_btn{font-family:bareun;color:#fff;background-color:#121F27;width:75px;font-size:14px;margin:5px 0;border:0;text-align:center;}
         .align_btn,.caption_date{background-color:#E4EEF0;text-align:center;}
         .page-link{width:200px;}
         select{width:100px;font-family:inherit;border:1px solid #999;border-radius:0;appearance:none;margin:5px 5px 5px 0;}
         ...
         .align_btn{font-family:bareun;color:#000;width:45%;height:50px;line-height:50px;margin-right:5px;margin-left:3%;border:0;margin-bottom:50px;font-size:16px;cursor:pointer;}
	</style>
 	</head>
	<body>
